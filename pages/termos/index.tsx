...
export default function Termos() {
  return (
    <Container className={styles.containerTermos} maxWidth="lg">
      <h2>Política de Privacidade</h2>
      <p>
        A sua privacidade é importante para nós. É política do Segurifique
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site Segurifique, e outros sites que possuímos e
        operamos.
      </p>
      <p>
      ...
      <p>
        ...
        informação que o Segurifique oferece no site e com caráter enunciativo,
        mas não limitativo:
      </p>
      <section>
        <p>
        ...
        <p>
          ...
          (softwares) do Segurifique, de seus fornecedores ou terceiros, para
      ...
      <p style={{ marginTop: '2rem' }}>
        <strong>
          Esta política é efetiva a partir de 16 outubro 2022 13:37
        </strong>
      </p>
      <h2>1. Termos</h2>
      <p>
        Ao acessar ao site Segurifique, concorda em cumprir estes termos de
      ...
      <p>
        ...
        materiais (informações ou software) no site Segurifique , apenas para
      ...
      <section>
        ...
        <p> 2) usar os materiais para qualquer finalidade comercial; </p>
        <p>
          {' '}
          3) tentar descompilar ou fazer engenharia reversa de qualquer software
          contido no site Segurifique;{' '}
        </p>
        <p>
          {' '}
      ...
      <p>
        ...
        dessas restrições e poderá ser rescindida por Segurifique a qualquer
      ...
      <section>
        <p>
          {' '}
          1) Os materiais no site da Segurifique são fornecidos "como estão".
          Segurifique não oferece garantias, expressas ou implícitas, e, por
        ...
        <p>
          {' '}
          2) Além disso, o Segurifique não garante ou faz qualquer representação
      ...
      <h2>4. Limitações</h2>
      <p>
        Em nenhum caso o Segurifique ou seus fornecedores serão responsáveis por
        ...
        incapacidade de usar os materiais em Segurifique, mesmo que Segurifique
        ou um representante autorizado da Segurifique tenha sido notificado
      ...
      <p>
        Os materiais exibidos no site da Segurifique podem incluir erros
        técnicos, tipográficos ou fotográficos. Segurifique não garante que
        qualquer material em seu site seja preciso, completo ou atual.
        Segurifique pode fazer alterações nos materiais contidos em seu site a
        qualquer momento, sem aviso prévio. No entanto, Segurifique não se
        compromete a atualizar os materiais.
      </p>
      <h4>Modificações</h4>
      <p>
        O Segurifique pode revisar estes termos de serviço do site a qualquer
      ...
      <p>
        ...
        leis do Segurifique e você se submete irrevogavelmente à jurisdição
